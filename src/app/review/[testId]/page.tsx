...
export default async function ReviewPage({ params }: ReviewPageProps) {
  ...
  try {
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-500 to-red-600">
          <div className="text-center text-white">
            ...
            <p className="text-xl mb-6">The test with ID {testId} could not be found.</p>
            <a href="/" className="px-6 py-3 bg-white text-red-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Go to Home
            </a>
          </div>
        </div>
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-500 to-orange-600">
          <div className="text-center text-white">
            ...
            <p className="text-xl mb-6">Review for {testData.data.questionType.toUpperCase()} tests is not available yet.</p>
            <a href="/" className="px-6 py-3 bg-white text-orange-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Go to Home
            </a>
          </div>
        </div>
    ...
    const { subjectName, topicName, subtopicName, testName, questions } = testData.data;
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-500 to-orange-600">
          <div className="text-center text-white">
            ...
            <p className="text-xl mb-6">This test has no questions associated with it.</p>
            <a href="/" className="px-6 py-3 bg-white text-orange-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Go to Home
            </a>
          </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-500 to-red-600">
        <div className="text-center text-white">
          ...
          <p className="text-xl mb-6">An error occurred while loading the test review.</p>
          <a href="/" className="px-6 py-3 bg-white text-red-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
            Go to Home
          </a>
        </div>
